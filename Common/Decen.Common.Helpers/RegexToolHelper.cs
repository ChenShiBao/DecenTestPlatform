...
namespace Decen.Common.Helpers
{
    ...
    /// 正则表达式 工具类
    /// </summary>
    public partial class RegexTool
    {
        /// <summary>
        /// 检测字符串中是否包含符合正则的子集
        /// </summary>
        ...
        /// <returns></returns>
        public static string GetAllString(string source)
        {
            return Regex.Replace(source, "[0-9]", "", RegexOptions.IgnoreCase);
        }
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static string GetAllNumeral(string source)
        {
            return Regex.Replace(source, "[a-z]", "", RegexOptions.IgnoreCase);
        }
    }
